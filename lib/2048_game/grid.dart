...
bool compare(List<List<int>> a, List<List<int>> b,int userInputRow,int userInputCol) {
...
List<List<int>> copyGrid(List<List<int>> grid,int userInputRow,int userInputCol) {
...
List<List<int>> transposeGrid(List<List<int>> grid,int userInputRow,int userInputCol) {
...
List<List<int>> addNumber(List<List<int>> grid,int userInputRow,int userInputCol) {
  List<Point> options = [];
  bool is64 = false;
  bool is128 = false;
  for (int i = 0; i < userInputRow; i++) {
